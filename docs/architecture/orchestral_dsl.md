...
- `docs/architecture/orchestral_dsl/INDEX.md`
...
Committed orchestral DSL files should not include note-generating loops or repeaters for sounding
material.
...
- [x] Author a substantial surface proof: `experiments/orchestral_dsl/storyteller_surface_study.rb`.
