...
with `partitura view SOURCE.rb melody_analysis --part PART` after importing or authoring the
...
Verify with `partitura view SOURCE.rb melody_analysis --part PART` -- the readout should show chord tones on the strong beats and
