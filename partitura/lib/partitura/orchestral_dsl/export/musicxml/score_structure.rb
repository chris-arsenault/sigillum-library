      ...
      module MusicXML
        module ScoreStructure
          ...
          def validate!
            ...
            raise Error, "unsupported orchestral DSL transport #{schema.inspect} version #{version.inspect}"
          end
          ...
          def render_header(xml)
            ...
            xml.element("creator", "Sigillum project", "type" => "composer")
            xml.open("encoding")
            xml.element("encoding-date", Date.today.iso8601)
            xml.element("software", "Sigillum Orchestral DSL Ruby exporter")
