production_piece "Workflow study", id: :workflow_study do
  meter "4/4"
  key "C"

  material :theme_a do
    identity pitch: "rising third", rhythm: "two half-note impulses"
  end

  roster do
    part :flute, "Flute", music21: "Flute"
    part :cello, "Violoncello", music21: "Violoncello"
  end

  section :whole, "Statement and return", bars: 1..4 do
  ...
  relation :depends_on, from: ref(:span, :return), to: ref(:span, :statement)
